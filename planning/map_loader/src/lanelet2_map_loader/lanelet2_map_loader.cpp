...
int main(int argc, char **argv)
{
  ...
  // lanelet::traffic_rules::TrafficRulesPtr pedestrianRules = lanelet::traffic_rules::TrafficRulesFactory::create(lanelet::Locations::Germany, lanelet::Participants::Pedestrian);
  // lanelet::routing::RoutingGraphConstPtr vehicleGraph = lanelet::routing::RoutingGraph::build(*map, *trafficRules);
  // lanelet::routing::RoutingGraphConstPtr pedestrGraph = lanelet::routing::RoutingGraph::build(*map, *pedestrianRules);
